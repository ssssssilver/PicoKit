...
const guideByHref: Record<string, ToolGuideDetails> = {
  ...
  "/one-click-ai-cleaner": guide(
    [text("只处理你有权编辑的 JPEG、PNG 或 WebP，并保留仍可能需要的原文件。", "Only process JPEG, PNG, or WebP images you have the right to edit, and keep any source file you may still need."), text("工具会清理支持的可见角标和来源字段，并进行轻量图像交付优化；不会伪造相机 EXIF，也不会改变真实创作来源。", "The tool cleans supported visible marks and provenance fields, then applies a light image-delivery normalization. It does not fabricate camera EXIF or change the real creation history.")],
