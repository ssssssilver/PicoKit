...
export function ImageWorkflowNav({ active }: { active: WorkflowStep }) {
  ...
  return (
    <section className="mb-6 overflow-hidden rounded-xl border border-cyan-300/20 bg-cyan-300/[.035]" aria-label={pick("图片交付流水线", "Image Delivery Pipeline")}>
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-white/10 px-4 py-3">
        <div>
          <p className="text-sm font-semibold text-zinc-100">{pick("图片交付流水线", "Image Delivery Pipeline")}</p>
