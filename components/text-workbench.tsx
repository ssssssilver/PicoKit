...
export function TextWorkbench() {
  ...
  return <div className="space-y-6">
    <Card><CardHeader><CardTitle>{pick("文本处理", "Count, Clean, Encode, and Decode Text")}</CardTitle></CardHeader><CardContent className="space-y-5">
