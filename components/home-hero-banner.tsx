...
export const homeHeroSlides: HeroSlide[] = [
  {
    id: "image-delivery",
    eyebrow: { zh: "主打功能 · 图片批量处理", en: "Batch Image Processing" },
    title: { zh: "一批图片，一次搞定。", en: "One image batch. One browser workspace." },
    description: { zh: "一次添加最多 30 张图片，去背景、修图、改尺寸、压缩和转换格式都在同一页完成，最后统一打包下载。切换功能不会清空图片，全程不上传文件。", en: "Import images once, then use background removal and refinement, per-image quick edits, format conversion, and compressed downloads only when needed. Skip any tool, return to saved queues, and keep files on your device." },
    action: { zh: "立即处理图片", en: "Open Batch Image Processing" },
    href: "/remove-background",
    imageSrc: "/illustrations/hero-image-workspace.webp",
  },
  {
    id: "documents",
    eyebrow: { zh: "主打功能 · PDF 批量处理", en: "Batch PDF Processing" },
    title: { zh: "多个 PDF，合并拆分一次完成。", en: "Organize PDF pages without handing the document to a cloud service." },
    description: { zh: "一次添加多个 PDF，每页都能看大图。拖动调整顺序，批量旋转、删除或提取页面，还能加页码、水印、压缩并导出。PDF 与图片互转也能直接使用。", en: "Add multiple PDFs to one page workspace, drag to reorder, batch-rotate, remove, or extract pages, and export in a background Worker. Image conversion remains available separately." },
    action: { zh: "立即处理 PDF", en: "Open Batch PDF Processing" },
    href: "/pdf-tools",
