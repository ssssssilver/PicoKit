          ...
          <div className="mx-auto max-w-[1280px] px-5 pb-14 pt-16 sm:px-8 lg:pb-16 lg:pt-20">
            <div className="grid gap-10 lg:grid-cols-[1fr_360px] lg:items-end">
              <div>
                ...
                <p className="mt-7 max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg"><Localized zh={`从准备文件到下载结果，逐步说明 ${toolGuides.length} 个本地工具的使用方式、结果验证、隐私边界与常见问题。`} en={`From preparing your file to downloading the result, learn all ${toolGuides.length} on-device tools with practical steps, verification checks, privacy boundaries, and troubleshooting.`} /></p>
