...
export const metadata: Metadata = {
  ...
  description: "一次导入最多 30 张图片，在浏览器本地连续完成批量去背景、修边、换背景、成品编辑、快速修图和打包交付。",
}

export default function Page() {
  return <ToolShell
    title={{ zh: "图片批量处理", en: "Batch Image Processing" }}
    description={{ zh: "一次加入最多 30 张图片，批量去除背景并逐张修边、换背景和制作成品；随后可直接继续修图，无需重新选择图片。", en: "Add up to 30 images, remove backgrounds in a batch, then refine edges, replace backgrounds, and finish each result. Continue directly to image editing without selecting the images again." }}
    ...
    aside={<ToolAside notes={[
      ...
      { zh: "可继续添加透明、纯色、渐变、自定义图片或模糊背景，并调整画布、主体位置和阴影", en: "Continue with a transparent, solid, gradient, custom-image, or blurred background, then adjust the canvas, subject position, and shadow" },
