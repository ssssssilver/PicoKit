...
export const metadata: Metadata = {
  title: "免费在线移除图片背景",
  description: "使用浏览器本地 MODNet 模型移除人像背景，导出透明 PNG；无需登录，不上传图片。",
}

export default function Page() {
  return <ToolShell
    title={{ zh: "一键移除图片背景", en: "Remove Image Backgrounds" }}
    description={{ zh: "最适合主体清晰的单人半身或全身人像。MODNet 在浏览器本地生成人像 Alpha 蒙版并导出透明 PNG，图片不会上传。", en: "Best for clear single-person half-body or full-body portraits. MODNet creates the portrait alpha matte locally in your browser and exports a transparent PNG without uploading your image." }}
    eyebrow="Local MODNet RemoveBG"
    icon={Scissors}
