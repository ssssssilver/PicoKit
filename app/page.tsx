...
export const metadata: Metadata = {
  title: "TabNative — 图片批量处理与 PDF 批量处理",
      ...
      <main>
        ...
        <section className="border-t border-white/10 bg-[#0d0d0d]">
          <div className="mx-auto grid max-w-[1280px] gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[.85fr_1.15fr] lg:py-20">
            <div>
              <p className="font-mono text-[11px] uppercase tracking-[.2em] text-cyan-300"><Localized zh="图片批量处理" en="Batch Image Processing" /></p>
